...
func (app *Application) listOrganizations(w http.ResponseWriter, r *http.Request) {
	...
	organizations, err := app.OrganizationService().ListOrganization(r.Context(), opts)
	if err != nil {
...
func (app *Application) getOrganizationOverview(w http.ResponseWriter, r *http.Request) {
	org, err := app.OrganizationService().GetOrganization(r.Context(), mux.Vars(r)["organization_name"])
	if err != nil {
		writeError(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (app *Application) editOrganization(w http.ResponseWriter, r *http.Request) {
	organization, err := app.OrganizationService().GetOrganization(r.Context(), mux.Vars(r)["organization_name"])
	if err != nil {
		writeError(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (app *Application) updateOrganization(w http.ResponseWriter, r *http.Request) {
	...
	org, err := app.OrganizationService().UpdateOrganization(r.Context(), mux.Vars(r)["organization_name"], &opts)
	if err != nil {
		writeError(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (app *Application) deleteOrganization(w http.ResponseWriter, r *http.Request) {
	...
	err := app.OrganizationService().DeleteOrganization(r.Context(), organizationName)
	if err != nil {
		writeError(w, err.Error(), http.StatusInternalServerError)
		return
	}
