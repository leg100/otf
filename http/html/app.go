...
func (app *Application) addRoutes(r *otfhttp.Router) {
	...
	r.Sub(func(r *otfhttp.Router) {
		...
		r.PST("/workspaces/{workspace_id}/permissions", app.setWorkspacePermission)
		r.PST("/workspaces/{workspace_id}/permissions/unset", app.unsetWorkspacePermission)
		r.GET("/workspaces/{workspace_id}/vcs-providers", app.listWorkspaceVCSProviders)
		r.GET("/workspaces/{workspace_id}/vcs-providers/{vcs_provider_id}/repos", app.listWorkspaceVCSRepos)
		r.PST("/workspaces/{workspace_id}/vcs-providers/{vcs_provider_id}/repos/connect", app.connectWorkspace)
		r.PST("/workspaces/{workspace_id}/repo/disconnect", app.disconnectWorkspace)
