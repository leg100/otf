...
ALTER TABLE workspaces ADD CONSTRAINT lock_run_id_fk FOREIGN KEY (lock_run_id) REFERENCES runs ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE workspaces ADD CONSTRAINT lock_user_id_fk FOREIGN KEY (lock_user_id) REFERENCES users ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE workspaces ADD COLUMN locked BOOLEAN;
