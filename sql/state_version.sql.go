...
func (s InsertStateVersionRow) GetWorkspaceID() *string { return s.WorkspaceID }
...
func (s FindStateVersionsByWorkspaceNameRow) GetState() pgtype.Bytea { return s.State }
func (s FindStateVersionsByWorkspaceNameRow) GetWorkspaceID() *string { return s.WorkspaceID }
func (s FindStateVersionsByWorkspaceNameRow) GetWorkspace() Workspaces { return s.Workspace }
...
func (s FindStateVersionByIDRow) GetState() pgtype.Bytea { return s.State }
func (s FindStateVersionByIDRow) GetWorkspaceID() *string { return s.WorkspaceID }
func (s FindStateVersionByIDRow) GetWorkspace() Workspaces { return s.Workspace }
...
func (s FindStateVersionLatestByWorkspaceIDRow) GetState() pgtype.Bytea { return s.State }
func (s FindStateVersionLatestByWorkspaceIDRow) GetWorkspaceID() *string { return s.WorkspaceID }
func (s FindStateVersionLatestByWorkspaceIDRow) GetWorkspace() Workspaces { return s.Workspace }
