...
type Querier interface {
	...
	FindPlanByID(ctx context.Context, planID pgtype.Text) (FindPlanByIDRow, error)
	// FindPlanByIDBatch enqueues a FindPlanByID query into batch to be executed
	// later by the batch.
	FindPlanByIDBatch(batch genericBatch, planID pgtype.Text)
	// FindPlanByIDScan scans the result of an executed FindPlanByIDBatch query.
	FindPlanByIDScan(results pgx.BatchResults) (FindPlanByIDRow, error)
...
func PrepareAllQueries(ctx context.Context, p preparer) error {
	...
	if _, err := p.Prepare(ctx, findPlanByIDSQL, findPlanByIDSQL); err != nil {
		return fmt.Errorf("prepare query 'FindPlanByID': %w", err)
	}
...
func (q *DBQuerier) InsertApply(ctx context.Context, params InsertApplyParams) (pgconn.CommandTag, error) {
	...
	cmdTag, err := q.conn.Exec(ctx, insertApplySQL, params.ApplyID, params.RunID, params.Status, params.Additions, params.Changes, params.Destructions)
	if err != nil {
...
func (q *DBQuerier) InsertApplyBatch(batch genericBatch, params InsertApplyParams) {
	batch.Queue(insertApplySQL, params.ApplyID, params.RunID, params.Status, params.Additions, params.Changes, params.Destructions)
}
