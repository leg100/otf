...
TESTS="${@:-Test(Workspaces(Create|List|Update|Delete|Unlock|Lock)|Organizations(Create|List|Read|Update)|StateVersions|Runs(List|Create|ReadWithOptions)|ConfigurationVersions)}"
