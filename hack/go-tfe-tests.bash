...
tests+=('TestAgentPoolsCreate')
tests+=('TestAgentPoolsUpdate')
tests+=('TestAgentPoolsRead/when')
tests+=('TestAgentPoolsRead/without')
tests+=('TestAgentPoolsList')
tests+=('TestAgentPoolsDelete')
