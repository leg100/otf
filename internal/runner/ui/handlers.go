...
type Client interface {
	...
	UpdateAgentPool(ctx context.Context, poolID resource.ID, opts runner.UpdatePoolOptions) (*runner.Pool, error)
	...
	GetAgentPool(ctx context.Context, poolID resource.ID) (*runner.Pool, error)
	DeleteAgentPool(ctx context.Context, poolID resource.ID) (*runner.Pool, error)
	CreateAgentToken(ctx context.Context, poolID resource.ID, opts runner.CreateAgentTokenOptions) (*runner.AgentToken, []byte, error)
	ListAgentTokens(ctx context.Context, poolID resource.ID) ([]*runner.AgentToken, error)
	DeleteAgentToken(ctx context.Context, tokenID resource.ID) (*runner.AgentToken, error)
