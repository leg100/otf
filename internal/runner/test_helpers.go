...
func (f *fakeService) allocateJob(ctx context.Context, jobID resource.ID, agentID resource.TfeID) (*Job, error) {
...
func (f *fakeService) reallocateJob(ctx context.Context, jobID resource.ID, agentID resource.TfeID) (*Job, error) {
