...
type apiClient interface {
	...
	UploadRunPlanFile(ctx context.Context, id resource.TfeID, plan []byte, format run.PlanFormat) error
	...
	PutChunk(ctx context.Context, opts run.PutChunkOptions) error
}
