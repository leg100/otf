...
func TestWorkspaceList(t *testing.T) {
	ws1 := &workspace.Workspace{ID: testutils.ParseID(t, "ws-123")}
	ws2 := &workspace.Workspace{ID: testutils.ParseID(t, "ws-123")}
	app := &CLI{
		client: &workspace.FakeService{Workspaces: []*workspace.Workspace{ws1, ws2}},
	}
