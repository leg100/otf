...
func (c *Client) Lock(ctx context.Context, workspaceID resource.ID, runID *string) (*Workspace, error) {
...
func (c *Client) Unlock(ctx context.Context, workspaceID resource.ID, runID *string, force bool) (*Workspace, error) {
	var u string
	if force {
