...
type Querier interface {
	...
	// later by the batch.
	FindVariableSetByIDBatch(batch genericBatch, variableSetID pgtype.Text)
	...
	// later by the batch.
	DeleteWorkspaceVariableByIDBatch(batch genericBatch, variableID pgtype.Text, workspaceID pgtype.Text)
