...
// TestIntegration_StateVersionsListUI tests the state versions list page,
// verifying versions are shown with serial numbers and navigation links.
func TestIntegration_StateVersionsListUI(t *testing.T) {
	integrationTest(t)
...
// TestIntegration_StateVersionJSONUI tests the state version detail page,
// verifying the raw JSON contents of the state file are shown.
func TestIntegration_StateVersionJSONUI(t *testing.T) {
	integrationTest(t)
...
// TestIntegration_StateVersionDiffUI tests the state version diff page.
func TestIntegration_StateVersionDiffUI(t *testing.T) {
	integrationTest(t)
