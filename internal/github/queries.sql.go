...
func (q *Queries) DeleteGithubApp(ctx context.Context, db DBTX, githubAppID pgtype.Int8) (GithubApp, error) {
	row := db.QueryRow(ctx, deleteGithubApp, githubAppID)
	var i GithubApp
	err := row.Scan(
		&i.GithubAppID,
		&i.WebhookSecret,
...
func (q *Queries) FindGithubApp(ctx context.Context, db DBTX) (GithubApp, error) {
	row := db.QueryRow(ctx, findGithubApp)
	var i GithubApp
	err := row.Scan(
		&i.GithubAppID,
		&i.WebhookSecret,
...
func (q *Queries) InsertGithubApp(ctx context.Context, db DBTX, arg InsertGithubAppParams) error {
	_, err := db.Exec(ctx, insertGithubApp,
		arg.GithubAppID,
		arg.WebhookSecret,
		arg.PrivateKey,
		arg.Slug,
...
func (q *Queries) InsertGithubAppInstall(ctx context.Context, db DBTX, arg InsertGithubAppInstallParams) error {
	_, err := db.Exec(ctx, insertGithubAppInstall,
		arg.GithubAppID,
		arg.InstallID,
		arg.Username,
		arg.Organization,
