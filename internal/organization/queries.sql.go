...
func (q *Queries) DeleteOrganizationByName(ctx context.Context, db DBTX, name Name) (resource.ID, error) {
...
func (q *Queries) FindOrganizationByName(ctx context.Context, db DBTX, name Name) (Model, error) {
...
func (q *Queries) FindOrganizationByNameForUpdate(ctx context.Context, db DBTX, name Name) (Model, error) {
