...
// URL path for the endpoint receiving VCS events from the Github App
const GithubAppEventsPath = "/webhooks/github-app"
...
// githubAppClient provides web handlers with access to github app service endpoints
...
func (h *githubApp) addHandlers(r *mux.Router) {
	r = html.UIRouter(r)
...
func (h *githubApp) new(w http.ResponseWriter, r *http.Request) {
	...
	m := manifest{
		...
		HookAttrs:   hookAttrs{URL: h.HostnameService.WebhookURL(GithubAppEventsPath)},
...
func (h *githubApp) get(w http.ResponseWriter, r *http.Request) {
...
func (h *githubApp) exchangeCode(w http.ResponseWriter, r *http.Request) {
	var params struct {
...
func (h *githubApp) delete(w http.ResponseWriter, r *http.Request) {
	app, err := h.svc.GetApp(r.Context())
	if err != nil {
		html.Error(r, w, err.Error())
		return
...
func (h *githubApp) deleteInstall(w http.ResponseWriter, r *http.Request) {
	var params struct {
